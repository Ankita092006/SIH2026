...
export default function GameMenu() {
  ...
  return (
    <div>
      <h1 style={{ fontSize: '2.5rem', marginBottom: '1rem' }}>Cognitive Games</h1>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
        {cognitiveGames.map(game => {
          const Icon = LucideIcons[game.iconName] || LucideIcons.Gamepad2;
          
          return (
            <div key={game.id} className="card" style={{ display: 'flex', flexDirection: 'column', gap: '1rem', margin: 0 }}>
